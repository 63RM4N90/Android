...
//		String departure = dealsList.get(position).getDeparture()
//				.getCityName();
//		String arrival = dealsList.get(position).getArrival()
//				.getCityName();
		...
		if (convertView == null) {
			...
			holder.airlineImg = (ImageView) convertView
					.findViewById(R.id.airline_deal_image_row);
			holder.dataTxt = (TextView) convertView
					.findViewById(R.id.data_row);
//			holder.statusTxt = (TextView) convertView
//					.findViewById(R.id.status_row);
...
//		holder.airlineImg.setImageResource((ih.getImage(dealsList
//				.get(position).getAirlineId())));
...
//		holder.statusTxt.setTextColor(sh.getStatusColor(dealsList.get(
//				position).getFlightStatus()));
//		holder.statusTxt.setText(sh.getStatus(dealsList.get(position)
//				.getFlightStatus()));
